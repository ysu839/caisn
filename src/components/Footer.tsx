...
export function Footer() {
  return (
    <footer className="border-t border-[var(--color-line)] px-[var(--gutter)] py-12">
      ...
      <div className="mt-10 flex flex-col gap-2 border-t border-[var(--color-line)] pt-6 text-xs tracking-[0.05em] text-[var(--color-fg-soft)] sm:flex-row sm:items-center sm:justify-between">
