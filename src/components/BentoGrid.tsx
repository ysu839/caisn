          ...
          return (
            ...
            >
              <CursorTarget label="VIEW" className="h-full w-full">
                ...
                <div className="pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#dfddd7] via-[#dfddd7]/85 to-transparent p-3 pt-6">
...
function BentoCardBody({ product, featured }: { product: Product; featured: boolean }) {
  ...
  return (
    <div className="product-stage relative h-full w-full">
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#dfddd7] via-[#dfddd7]/85 to-transparent p-4 pt-8">
        <p
